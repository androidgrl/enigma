...
class TestEncryptor < Minitest::Test
  ...
  def test_it_can_find_the_new_encrypted_text_for_non_default_parameters
    enc = Encryptor.new("ruby", [9,2,2,5], [41,15,52,21])
    assert_equal "2.ql", enc.encrypt
    enc = Encryptor.new("it is all sunshine and butterflies", [9,2,2,5], [13,34,44,44])
    assert_equal "4qesb7hv77z49pos9bek9aeldq0oacss0p", enc.encrypt
    enc = Encryptor.new("cat", )
  end

  # def test_it_can_find_letter_indices
  #   mc = MasterCipher.new("blondie", [1,1,1,1], [2,2,2,2])
  #   assert_equal [0,19,14,12,8,2], mc.build_message_indices
  # end
  #
